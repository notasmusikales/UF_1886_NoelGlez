...
Fecha: (27/02/2026)  
Responsable: (Noel Alejandro González Febles)
...
docker exec -it odoo-qa bash -lc "odoo -d odoo_qa -u custom_sale_codes --stop-after-init"
...
```bash
docker exec -it odoo-prod bash -lc "odoo -d odoo_prod -u custom_sale_codes --stop-after-init"
```
